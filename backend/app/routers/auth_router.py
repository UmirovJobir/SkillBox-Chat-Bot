...
def register_user(
    ...
    database_session: Session = Depends(get_database_session),  # сессия БД
):
    """
    ...
    existing_by_telegram = find_user_by_telegram_id(
    ...
    existing_by_username = find_user_by_username(
    ...
    new_user = create_user(database_session, user_data)
